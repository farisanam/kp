                    ...
                    <div class="panel-body">                                    
                        <form id="pelangganForm" class="form-horizontal" role="form" action="<?= base_url('pelanggan/simpan') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="telepon" placeholder="08xxxxxxxxxx" pattern="[0-9]{10,14}" title="Masukkan angka antara 10-14 digit tanpa spasi" maxlength="14" required>
                                </div>
                            </div>
