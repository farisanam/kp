                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">		
                                    <select class="form-control" name="id">    
                                        ...
                                        <option value="<?= $exit["id"]; ?>"><?= $exit["nama_konsumen"]; ?> - <?php $masuk = $exit['masuk']; $dateMasuk = date_create("$masuk"); echo date_format($dateMasuk,"d/m/Y"); ?> - <?= $exit["kategori"]; ?> - <?= $exit["paket"]; ?> - <?= $exit["pcs"]; ?> pcs </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
